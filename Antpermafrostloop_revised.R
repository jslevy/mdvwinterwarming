...
#has corrected LW v DVWD graph, adjusted y-axis, changed wind velocity days to wind run, has r values 
#To calculate the yearly wind run in (km) values we multiply the mean daily wind speed by the number of seconds in a day and sum all the daily wind run values together
...
for(location in locations){
  ...
  if(location == "Lake Bonney"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7003/20/d7abf1a2a9976be5e83f6b1768555ca7")
  ...
  if(location == "Explorers Cove"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7008/18/6d4c52a8b7e4d6a80398870bb282189c")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  if(location == "Lake Brownworth"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7005/35/ce472c55ddac70c398d88c9d8960c83e")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  ...
  if(location == "Lake Fryxell"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7010/17/b16d273c65f847ade1e9bad75845327b")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  if(location == "Lake Hoare"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7011/19/fad54a37da563d3c64dcabb1738c9179")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  if(location == "Lake Vanda"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7015/18/347b05d46700d107d13e15b70c21b6cf")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  if(location == "Lake Vida"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7016/20/4fab17de397c23d773aed23cd1bedec2")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  if(location == "Miers Valley"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7020/12/2709de0f2a10f8222a62a49cc5c8ef6d")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  if(location == "Mount Fleming"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7018/12/c50d396bff6815fd0d962417e76ccaf0")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  if(location == "Taylor Glacier"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7013/18/48536ea34badc3e8ff346e499d73122c")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  if(location == "Canada Glacier"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7006/31/7084e9e9c0c905d3be119baf629a11f9")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  if(location == "Commonwealth Glacier"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7007/20/6f076ae6060c28bc4107695ff4ef3138")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  if(location == "Howard Glacier"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7012/17/57fc6061b51e63ced3a063f86d072935")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  if(location == "Friis Hills"){
    ...
    #loads in wind data
    windall <- read.csv("https://pasta.lternet.edu/package/data/eml/knb-lter-mcm/7017/14/a0c2db9b24a324337f40515eca092872")
    #just date, direction, speed
    wind <- windall[,c(3,4,6)]
  }
  ...
  ##Since most of the data sets don't have longwave data we try to match locations with sites that do have it. All values calculated will be noted
  ...
  if(soiltempcheck){
    plot(pfdat$AVG_SOILT0CM~pfdat$decimalyear, type = "l", ylab = "Temperature (\u00B0C)", xlab = "Year", main = paste(location, "Daily Soil Temperature"))
  }
  #Daily Air Temperature plot
  plot(airtemp$AVG_AIRT3M~airtemp$decimalyear, type = "l", ylab = "Temperature (\u00B0C)", xlab = "Year", main = paste(location, "Daily Air Temperature"))
  ...
  if(soiltempcheck){
    plot(pfdat_winter$AVG_SOILT0CM~pfdat_winter$decimalyear, pch = 20, ylab = "Temperature (\u00B0C)", xlab = "Year", main = paste(location, "Winter Temperatures"))+
      abline(h = meanT0)+
      abline(h = ourmax)+
      abline(h = ourmin)+
    ...
    plot(mins$Group.1, mins$x, ylab = "Temperature (\u00B0C)", xlab = "Year", main = paste(location, "Minimum Winter Temperature"), pch = 20)
    abline(lm(mins$x~mins$Group.1))
    iswinterwarming <- lm(mins$x~mins$Group.1)
    summary(iswinterwarming)
    
    #Plots yearly wintertime maxes
    plot(maxes$Group.1, maxes$x, ylab = "Temperature (\u00B0C)", xlab = "Year", main = paste(location, "Maximum Winter Temperature"), pch = 20)
  ...
  if(soiltempcheck){
    plot(temptotalforyear0cm$year, temptotalforyear0cm$totaltemp0, ylab = "Soil Freezing Index (Summed FDD)", xlab = "Year", main = paste(location, "Winter Soil Freezing Index"), col = "black", pch = 20, ylim = c((min(temptotalforyear0cm$totaltemp0, na.rm = TRUE)-10),(max(temptotalforyear10cm$totaltemp10, na.rm = TRUE)+10)))
    ...
    rvalueFDD0cm <- cor(temptotalforyear0cm$year, temptotalforyear0cm$totaltemp0,method="pearson", use = "na.or.complete")
    ...
    rvalueFDD5cm <- cor(temptotalforyear5cm$year, temptotalforyear5cm$totaltemp5,method="pearson", use = "na.or.complete")
    ...
    rvalueFDD10cm <- cor(temptotalforyear10cm$year, temptotalforyear10cm$totaltemp10,method="pearson", use = "na.or.complete")
  }
  #Plot data: This plots air temperature freezing degree days
  plot(airtemptotalforyear$year, airtemptotalforyear$totaltempair, ylab = "Air Freezing Index (Summed FDD)", xlab = "Year", main = paste(location, "Winter Air Freezing Index"), col = "black", pch = 20)
  ...
  rvalueFDDAir <- cor(airtemptotalforyear$year, airtemptotalforyear$totaltempair,method="pearson", use = "na.or.complete")
  ...
  plot(winddat_winter$AVG_WSPD~winddat_winter$decimalyear, pch = 20, ylab = "Wind Speed (m/s)", xlab = "Year", main = paste(location, "Winter Daily Wind Speed"))
  ...
  ##Wind Run
  #calculate wind run in km by multiplying wind days by seconds in a day
  #Just like the freezing degree days this section looks at the total wind during the winter for each year. This will give us a broad sense of how much wind the area experienced during the winter. A more detailed analysis will look into the Down-Valley Winds.
  ...
  totalwinddays$totalwind <- (totalwinddays$totalwind*86400)/1000 #wind run in km
  ...
  totalwinddays_noDW$totalwind_noDW <- (totalwinddays_noDW$totalwind_noDW*86400)/1000 #wind run in km
  
  plot(totalwinddays$year, totalwinddays$totalwind, pch = 20, ylab = "Wind Run (km)", xlab = "Year", main = "Yearly Winter Wind Total")
  ...
  rvalueWD <- cor(totalwinddays$year, totalwinddays$totalwind, method="pearson", use = "na.or.complete")
  
  plot(totalwinddays_noDW$year, totalwinddays_noDW$totalwind_noDW, pch = 20, ylab = "Wind Run (km)", xlab = "Year", main = "Yearly Winter Wind Total Down-Valley\n Wind Days Removed (mean ws <5m/s)")
  abline(lm(totalwinddays_noDW$totalwind_noDW~totalwinddays_noDW$year))
  ...
  rvalueWD_noDW <- cor(totalwinddays_noDW$year, totalwinddays_noDW$totalwind_noDW, method="pearson", use = "na.or.complete")
  ...
  temptotalforyear0cmnhwe <- setNames(temptotalforyear0cmnhwe, c("year", "totaltemp0nhwe"))
  temptotalforyear5cmnhwe <- aggregate(wintertempnhwe$AVG_SOILT5CM, list(wintertempnhwe$year), sum)
  temptotalforyear5cmnhwe <- setNames(temptotalforyear5cmnhwe, c("year", "totaltemp5nhwe"))
  temptotalforyear10cmnhwe <- aggregate(wintertempnhwe$AVG_SOILT10CM, list(wintertempnhwe$year), sum)
  temptotalforyear10cmnhwe <- setNames(temptotalforyear10cmnhwe, c("year", "totaltemp10nhwe"))
  airtemptotalforyearnhwe <- aggregate(winterairtempnhwe$AVG_AIRT3M, list(winterairtempnhwe$year), sum)
  airtemptotalforyearnhwe <- setNames(airtemptotalforyearnhwe, c("year", "totaltempairnhwe"))
  
  #Plots the yearly soil temperature without Down-Valley Wind Days
  if(soiltempcheck){
    plot(temptotalforyear0cmnhwe$totaltemp0nhwe~temptotalforyear0cmnhwe$year, ylab = "Soil Freezing Index (Summed FDD)", xlab = "Year", main = paste(location, "Freezing Index\n (Down-Valley Wind Days removed)"), col = "black", pch = 20, ylim = c((min(temptotalforyear0cmnhwe$totaltemp0, na.rm = TRUE)-10),(max(temptotalforyear10cmnhwe$totaltemp10, na.rm = TRUE)+10)))
    abline(lm(temptotalforyear0cmnhwe$totaltemp0nhwe~temptotalforyear0cmnhwe$year), col = "black")
    points(temptotalforyear5cmnhwe$year, temptotalforyear5cmnhwe$totaltemp5nhwe, col = "green", pch = 20)
    abline(lm(temptotalforyear5cmnhwe$totaltemp5nhwe~temptotalforyear5cmnhwe$year), col= "green")
    points(temptotalforyear10cmnhwe$year, temptotalforyear10cmnhwe$totaltemp10nhwe, col = "red", pch = 20)
    abline(lm(temptotalforyear10cmnhwe$totaltemp10nhwe~temptotalforyear10cmnhwe$year), col= "red")
    legend("bottomright", legend = c("0cm", "5cm", "10cm"), col = c("black", "green", "red"), pch = 20)
    #This gives us the statistical values for the linear best fit lines
    iswinterwarmingFDD0cmnhwe <- lm(temptotalforyear0cmnhwe$totaltemp0nhwe~temptotalforyear0cmnhwe$year)
    sumiswinterwarmingFDD0cmnhwe <- summary(iswinterwarmingFDD0cmnhwe)
    rvalueFDD0cmnhwe <- cor(temptotalforyear0cmnhwe$year,temptotalforyear0cmnhwe$totaltemp0nhwe, method = "pearson", use = "na.or.complete")
    iswinterwarmingFDD5cmnhwe <- lm(temptotalforyear5cmnhwe$totaltemp5nhwe~temptotalforyear5cmnhwe$year)
    sumiswinterwarmingFDD5cmnhwe <- summary(iswinterwarmingFDD5cmnhwe)
    rvalueFDD5cmnhwe <- cor(temptotalforyear5cmnhwe$year,temptotalforyear5cmnhwe$totaltemp5nhwe, method = "pearson", use = "na.or.complete")
    iswinterwarmingFDD10cmnhwe <- lm(temptotalforyear10cmnhwe$totaltemp10nhwe~temptotalforyear10cmnhwe$year)
    sumiswinterwarmingFDD10cmnhwe <- summary(iswinterwarmingFDD10cmnhwe)
    rvalueFDD10cmnhwe <- cor(temptotalforyear10cmnhwe$year,temptotalforyear10cmnhwe$totaltemp10nhwe, method = "pearson", use = "na.or.complete")
  }
  #Plots the yearly air temperature without Down-Valley Wind Days
  plot(airtemptotalforyearnhwe$year, airtemptotalforyearnhwe$totaltempairnhwe, ylab = "Air Freezing Index (Summed FDD)", xlab = "Year", main = paste(location, "Air Freezing Index\n (Down-Valley Wind Days removed)"), col = "black", pch = 20)
  abline(lm(airtemptotalforyearnhwe$totaltempair~airtemptotalforyearnhwe$year), col = "black")
  #This gives us the statistical values for the best fit lines
  iswinterwarmingFDDAirnhwe <- lm(airtemptotalforyearnhwe$totaltempairnhwe~airtemptotalforyearnhwe$year)
  sumiswinterwarmingFDDAirnhwe <- summary(iswinterwarmingFDDAirnhwe)
  rvalueFDDAirnhwe <- cor(airtemptotalforyearnhwe$year,airtemptotalforyearnhwe$totaltempairnhwe, method = "pearson", use = "na.or.complete")
  ...
  plot(wind$wspd~wind$wdir, pch = ".", main = paste(location, "Wind Speed and Direction"), xlab = "Wind Direction", ylab = "Wind Speed (m/s)")
  
  #replaces 0s with NA
  wind[wind == 0] <- NA
  wind <- wind[complete.cases(wind$wspd),]
  ...
  #Clean data: Make sure that each YEAR has at least 90% of the days if it doesn't 
  #we will ignore that year
  windsum <- fullwindsum
  ...
  plot(DWs_by_year$DWperyear~DWs_by_year$year, pch = 20, ylab = "Number of Down-Valley Wind Events", xlab = "Year", main = paste(location, "Yearly Down-Valley Wind Event Days"))
  ...
  justDWswinter25 <- windsumwinter[windsumwinter$DW_frac>0.25,]
  ...
  DWs_by_yearwinter25 <- aggregate(justDWswinter25$DWeventsperday, by = list(justDWswinter25$year), FUN = "length")
  DWs_by_yearwinter25 <- setNames(DWs_by_yearwinter25, c("year", "DWperyear25"))
  ...
  dwby25 <- lm(DWs_by_yearwinter25$DWperyear25~DWs_by_yearwinter25$year)
  
  plot(DWs_by_yearwinter$DWperyear~DWs_by_yearwinter$year, pch = 20, ylab = "Number of Down-Valley Wind Days", xlab = "Year", main = paste(location, "Yearly Wintertime Down-Valley Wind Days\n (50% Fractional Day Threshold)"), ylim = c(0,(max(DWs_by_yearwinter$DWperyear)+2)))
  abline(dwby50)
  plot(DWs_by_yearwinter2$DWperyear2~DWs_by_yearwinter2$year, pch = 20, ylab = "Number of Down-Valley Wind Days", xlab = "Year", main = paste(location, "Yearly Wintertime Down-Valley Wind Days\n (60% Fractional Day Threshold)"), ylim = c(0,(max(DWs_by_yearwinter$DWperyear)+2)))
  abline(dwby60)
  plot(DWs_by_yearwinter3$DWperyear3~DWs_by_yearwinter3$year, pch = 20, ylab = "Number of Down-Valley Wind Days", xlab = "Year", main = paste(location, "Yearly Wintertime Down-Valley Wind Days\n (70% Fractional Day Threshold)"), ylim = c(0,(max(DWs_by_yearwinter$DWperyear)+2)))
  abline(dwby70)
  plot(DWs_by_yearwinter4$DWperyear4~DWs_by_yearwinter4$year, pch = 20, ylab = "Number of Down-Valley Wind Days", xlab = "Year", main = paste(location, "Yearly Wintertime Down-Valley Wind Days\n (80% Fractional Day Threshold)"), ylim = c(0,(max(DWs_by_yearwinter$DWperyear)+2)))
  abline(dwby80)
  plot(DWs_by_yearwinter25$DWperyear25~DWs_by_yearwinter25$year, pch = 20, ylab = "Number of Down-Valley Wind Days", xlab = "Year", main = paste(location, "Yearly Wintertime Down-Valley Wind Days\n (25% Fractional Day Threshold)"), ylim = c(0,(max(DWs_by_yearwinter25$DWperyear25)+2)))
  abline(dwby25)
  ...
  sumdwby25 <- summary(dwby25)
  
  rvaluedwby50 <- cor(DWs_by_yearwinter$year, DWs_by_yearwinter$DWperyear, method = "pearson", use = "na.or.complete")
  rvaluedwby60 <- cor(DWs_by_yearwinter2$year, DWs_by_yearwinter2$DWperyear2, method = "pearson", use = "na.or.complete")
  rvaluedwby70 <- cor(DWs_by_yearwinter3$year, DWs_by_yearwinter3$DWperyear3, method = "pearson", use = "na.or.complete")
  rvaluedwby80 <- cor(DWs_by_yearwinter4$year, DWs_by_yearwinter4$DWperyear4, method = "pearson", use = "na.or.complete")
  rvaluedwby25 <- cor(DWs_by_yearwinter25$year, DWs_by_yearwinter25$DWperyear25, method = "pearson", use = "na.or.complete")
  
  #No drainage wind temp
  NoDWswinter <- windsumwinter[windsumwinter$DW_frac<0.5,]
  NoDWswinter2 <- windsumwinter[windsumwinter$DW_frac<0.6,]
  NoDWswinter3 <- windsumwinter[windsumwinter$DW_frac<0.7,]
  NoDWswinter4 <- windsumwinter[windsumwinter$DW_frac<0.8,]
  NoDWswinter25 <- windsumwinter[windsumwinter$DW_frac<0.25,]
  
  #Removes days that are classified as high wind events from the temperature data using 25% threshold (instead of using the basic DW indentifier discussed above of any day >5m/s this uses the high frequency data)
  df_list4 <- list(pfdat_winter[,c(3,8,13,19)], NoDWswinter25[,c(which(colnames(NoDWswinter)=="year"),which(colnames(NoDWswinter)=="date"))]) #have to create a list by the date
  wintertempnoDW <- Reduce(function(x, y) merge(x, y, all=TRUE), df_list4) #combines the data based on the date
  wintertempnoDW <- wintertempnoDW[complete.cases(wintertempnoDW),] #by looking at complete cases it removes the days with Drainage Wind
  wintertempnoDW$decimalyear <- decimal_date(wintertempnoDW$date)
  wintertempnoDW$year <- floor(wintertempnoDW$decimalyear)
  
  #Repeats for air temperature
  df_list4 <- list(airtemp_winter[,c(which(colnames(airtemp_winter)=="AVG_AIRT3M"),which(colnames(airtemp_winter)=="date"))], NoDWswinter25[,c(which(colnames(NoDWswinter)=="year"),which(colnames(NoDWswinter)=="date"))])
  winterairtempnoDW <- Reduce(function(x, y) merge(x, y, all=TRUE), df_list4)
  winterairtempnoDW <- winterairtempnoDW[complete.cases(winterairtempnoDW),]
  winterairtempnoDW$decimalyear <- decimal_date(winterairtempnoDW$date)
  winterairtempnoDW$year <- floor(winterairtempnoDW$decimalyear)
  
  #calculates temperature FDD without Drainage Wind events. 
  temptotalforyear0cmnoDW <- aggregate(wintertempnoDW$AVG_SOILT0CM, list(wintertempnoDW$year), mean)
  temptotalforyear0cmnoDW <- setNames(temptotalforyear0cmnoDW, c("year", "meantemp0noDW"))
  temptotalforyear5cmnoDW <- aggregate(wintertempnoDW$AVG_SOILT5CM, list(wintertempnoDW$year), mean)
  temptotalforyear5cmnoDW <- setNames(temptotalforyear5cmnoDW, c("year", "meantemp5noDW"))
  temptotalforyear10cmnoDW <- aggregate(wintertempnoDW$AVG_SOILT10CM, list(wintertempnoDW$year), mean)
  temptotalforyear10cmnoDW <- setNames(temptotalforyear10cmnoDW, c("year", "meantemp10noDW"))
  airtemptotalforyearnoDW <- aggregate(winterairtempnoDW$AVG_AIRT3M, list(winterairtempnoDW$year), mean)
  airtemptotalforyearnoDW <- setNames(airtemptotalforyearnoDW, c("year", "meantempairnoDW"))
  
  #Plots the yearly soil temperature without Drainage Wind days
  if(soiltempcheck){
    plot(temptotalforyear0cmnoDW$meantemp0noDW~temptotalforyear0cmnoDW$year, ylab = "Average Temperature (\u00B0C)", xlab = "Year", main = "Mean Yearly Soil Wintertime Temperature\n (Drainage Wind days removed 25%)", col = "black", pch = 20, ylim = c((min(temptotalforyear0cmnoDW$meantemp0, na.rm = TRUE)-10),(max(temptotalforyear0cmnoDW$meantemp0, na.rm = TRUE)+1)))
    abline(lm(temptotalforyear0cmnoDW$meantemp0noDW~temptotalforyear0cmnoDW$year), col = "black")
    points(temptotalforyear5cmnoDW$year, temptotalforyear5cmnoDW$meantemp5noDW, col = "green", pch = 20)
    abline(lm(temptotalforyear5cmnoDW$meantemp5noDW~temptotalforyear5cmnoDW$year), col= "green")
    points(temptotalforyear10cmnoDW$year, temptotalforyear10cmnoDW$meantemp10noDW, col = "red", pch = 20)
    abline(lm(temptotalforyear10cmnoDW$meantemp10noDW~temptotalforyear10cmnoDW$year), col= "red")
    legend("bottomright", legend = c("0cm", "5cm", "10cm"), col = c("black", "green", "red"), pch = 20)
    #This gives us the statistical values for the linear best fit lines
    iswinterwarmingFDD0cmnoDW <- lm(temptotalforyear0cmnoDW$meantemp0noDW~temptotalforyear0cmnoDW$year)
    sumiswinterwarmingFDD0cmnoDW <- summary(iswinterwarmingFDD0cmnoDW)
    rvalueFDD0cmnoDW <- cor(temptotalforyear0cmnoDW$year, temptotalforyear0cmnoDW$meantemp0noDW, method = "pearson", use = "na.or.complete")
    iswinterwarmingFDD5cmnoDW <- lm(temptotalforyear5cmnoDW$meantemp5noDW~temptotalforyear5cmnoDW$year)
    sumiswinterwarmingFDD5cmnoDW <- summary(iswinterwarmingFDD5cmnoDW)
    rvalueFDD5cmnoDW <- cor(temptotalforyear5cmnoDW$year, temptotalforyear5cmnoDW$meantemp5noDW, method = "pearson", use = "na.or.complete")
    iswinterwarmingFDD10cmnoDW <- lm(temptotalforyear10cmnoDW$meantemp10noDW~temptotalforyear10cmnoDW$year)
    sumiswinterwarmingFDD10cmnoDW <- summary(iswinterwarmingFDD10cmnoDW)
    rvalueFDD10cmnoDW <- cor(temptotalforyear10cmnoDW$year, temptotalforyear10cmnoDW$meantemp10noDW, method = "pearson", use = "na.or.complete")
  }
  #Plots the yearly air temperature without Drainage Wind days
  plot(airtemptotalforyearnoDW$year, airtemptotalforyearnoDW$meantempairnoDW, ylab = "Average Temperature (\u00B0C)", xlab = "Year", main = "Mean Yearly Air Wintertime Temperature\n (Drainage Wind days removed 25%)", col = "black", pch = 20)
  abline(lm(airtemptotalforyearnoDW$meantempairnoDW~airtemptotalforyearnoDW$year), col = "black")
  #This gives us the statistical values for the best fit lines
  iswinterwarmingFDDAirnoDW <- lm(airtemptotalforyearnoDW$meantempairnoDW~airtemptotalforyearnoDW$year)
  sumiswinterwarmingFDDAirnoDW <- summary(iswinterwarmingFDDAirnoDW)
  rvalueFDDAirnoDW <- cor(airtemptotalforyearnoDW$year, airtemptotalforyearnoDW$meantempairnoDW, method = "pearson", use = "na.or.complete")
  ...
  radiation <- radiation[complete.cases(radiation$AVG_LWRADIN),] #Since we are only looking at longwave radiation we only want data with it
  ...
  plot(totalradiationdays$year, totalradiationdays$totalradiation, ylab = "Longwave Radiation Days", xlab = "Year", main = paste(location, "Yearly Winter Longwave Radiation Total"), pch = 20)
  ...
  rvalueRD <- cor(totalradiationdays$year, totalradiationdays$totalradiation, method = "pearson", use = "na.or.complete")
  
  #Clean Data
  #Combine all data in one data frame (Make it easier to remove incomplete rows)
  
  df_list <- list(totalwinddays, temptotalforyear0cm, temptotalforyear5cm, temptotalforyear10cm, airtemptotalforyear, DWs_by_yearwinter, DWs_by_yearwinter2, DWs_by_yearwinter3, DWs_by_yearwinter4, DWs_by_yearwinter25, totalradiationdays, totalwinddays_noDW, DWfrac, temptotalforyear0cmnhwe, temptotalforyear5cmnhwe, temptotalforyear10cmnhwe, airtemptotalforyearnhwe, temptotalforyear0cmnoDW, temptotalforyear5cmnoDW, temptotalforyear10cmnoDW, airtemptotalforyearnoDW)
  ...
  if(soiltempcheck){
    plot(combineddata$totalwind, combineddata$totaltemp0, pch = 20, main = paste(location, "Wintertime Wind\n and Soil Freezing Index"), xlab = "Wind Run (km)", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(combineddata$totaltemp0, na.rm = TRUE)-10),(max(combineddata$totaltemp10, na.rm = TRUE)+10)))
    ...
    rvaluewindvtemp0 <- cor(combineddata$totalwind, combineddata$totaltemp0, method = "pearson", use = "na.or.complete")
    windvtemp5 <- lm(combineddata$totaltemp5~combineddata$totalwind)
    sumwindvtemp5 <- summary(windvtemp5)
    rvaluewindvtemp5 <- cor(combineddata$totalwind, combineddata$totaltemp5, method = "pearson", use = "na.or.complete")
    windvtemp10 <- lm(combineddata$totaltemp10~combineddata$totalwind)
    sumwindvtemp10 <- summary(windvtemp10)
    rvaluewindvtemp10 <- cor(combineddata$totalwind, combineddata$totaltemp10, method = "pearson", use = "na.or.complete")
    
    #Same plot but no Down-Valley Wind events
    plot(combineddata$totalwind_noDW, combineddata$totaltemp0, pch = 20, main = paste(location, "Wintertime Wind and\n Soil Freezing Index (Down-Valley Wind Days removed)"), xlab = "Wind Run (km)", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(combineddata$totaltemp0, na.rm = TRUE)-10),(max(combineddata$totaltemp10, na.rm = TRUE)+10)))
    ...
    rvaluewindvtemp0_noDW <- cor(combineddata$totalwind_noDW, combineddata$totaltemp0, method = "pearson", use = "na.or.complete")
    windvtemp5_noDW <- lm(combineddata$totaltemp5~combineddata$totalwind_noDW)
    sumwindvtemp5_noDW <- summary(windvtemp5_noDW)
    rvaluewindvtemp5_noDW <- cor(combineddata$totalwind_noDW, combineddata$totaltemp5, method = "pearson", use = "na.or.complete")
    windvtemp10_noDW <- lm(combineddata$totaltemp10~combineddata$totalwind_noDW)
    sumwindvtemp10_noDW <- summary(windvtemp10_noDW)
    rvaluewindvtemp10_noDW <- cor(combineddata$totalwind_noDW, combineddata$totaltemp10, method = "pearson", use = "na.or.complete")
  }
  #Looks at daily Data
  ...
  plot(combineddata$totalwind, combineddata$totaltempair, pch = 20, main = paste(location, "Wintertime Wind\n and Air Freezing Index"), xlab = "Wind Run (km)", ylab = "Air Freezing Index (Summed FDD)")
  ...
  rvaluewindvtempair <- cor(combineddata$totalwind, combineddata$totaltempair, method = "pearson", use = "na.or.complete")
  
  #air temperature v wind no Down-Valley Wind events
  plot(combineddata$totalwind_noDW, combineddata$totaltempair, pch = 20, main = paste(location, "Wintertime Wind and\n Air Freezing Index (Down-Valley Wind Days removed <5m/s)"), xlab = "Wind Run (km)", ylab = "Air Freezing Index (Summed FDD)")
  ...
  rvaluewindvtempair_noDW <- cor(combineddata$totalwind_noDW, combineddata$totaltempair, method = "pearson", use = "na.or.complete")
  
  ##Longwave Radiation v soil Temperature 
  #Makes wind and soil temperature plot. This includes best fit lines for each depth.
  if(soiltempcheck){
    plot(combineddata$totalradiation, combineddata$totaltemp0, pch = 20, main = paste(location, "Longwave Radiation\n and Soil Freezing Index"), xlab = expression("Radiation W/m"^2*" Days"), ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(combineddata$totaltemp0, na.rm = TRUE)-10),(max(combineddata$totaltemp10, na.rm = TRUE)+10)))
    ...
    rvalueradvtemp0 <- cor(combineddata$totalradiation, combineddata$totaltemp0, method = "pearson", use = "na.or.complete")
    radvtemp5 <- lm(combineddata$totaltemp5~combineddata$totalradiation)
    sumradvtemp5 <-summary(radvtemp5)
    rvalueradvtemp5 <- cor(combineddata$totalradiation, combineddata$totaltemp5, method = "pearson", use = "na.or.complete")
    radvtemp10 <- lm(combineddata$totaltemp10~combineddata$totalradiation)
    sumradvtemp10 <- summary(radvtemp10)
    rvalueradvtemp10 <- cor(combineddata$totalradiation, combineddata$totaltemp10, method = "pearson", use = "na.or.complete")
  }
  
  ##Longwave radiation v Air temperature
  plot(combineddata$totalradiation, combineddata$totaltempair, pch = 20, main = paste(location, "Wintertime Longwave Radiation\n and Air Freezing Index"), xlab = "Radiation W/m^2 Days", ylab = "Air Freezing Index (Summed FDD)")
  ...
  rvalueradvtempair <- cor(combineddata$totalradiation, combineddata$totaltempair, method = "pearson", use = "na.or.complete")
  
  ##Down-Valley Winds v Temperature
  #compares Down-Valley Wind Days per year to soil temperature 0,5,10 cm (50%)
  if(soiltempcheck){
    plot(combineddata$totaltemp0~combineddata$DWperyear, pch = 20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Soil Freezing Index (50%)"), xlab = "Down-Valley Wind Days", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(combineddata$totaltemp0, na.rm = TRUE)-10),(max(combineddata$totaltemp10, na.rm = TRUE)+10)))
    ...
    rvalueDWvtemp0 <- cor(combineddata$DWperyear, combineddata$totaltemp0, method ="pearson", use = "na.or.complete")
    DWvtemp5 <- lm(combineddata$totaltemp5~combineddata$DWperyear)
    sumDWvtemp5 <- summary(DWvtemp5)
    rvalueDWvtemp5 <- cor(combineddata$DWperyear, combineddata$totaltemp5, method ="pearson", use = "na.or.complete")
    DWvtemp10 <- lm(combineddata$totaltemp10~combineddata$DWperyear)
    sumDWvtemp10 <- summary(DWvtemp10)
    rvalueDWvtemp10 <- cor(combineddata$DWperyear, combineddata$totaltemp10, method ="pearson", use = "na.or.complete")
  }
  
  #compares Down-Valley Wind Days per year to air temp (50%)
  plot(combineddata$totaltempair~combineddata$DWperyear, pch =20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Air Freezing Index (50%)"), xlab = "Down-Valley Wind Days", ylab = "Air Freezing Index (Summed FDD)")
  ...
  rvalueDWvairtemp <- cor(combineddata$DWperyear, combineddata$totaltempair, method = "pearson", use = "na.or.complete")
  
  if(soiltempcheck){
    #compares Down-Valley Wind Days per year to soil temperature 0,5,10 cm (60%)
    plot(combineddata$totaltemp0~combineddata$DWperyear2, pch = 20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Soil Freezing Index (60%)"), xlab = "Down-Valley Wind Days", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(combineddata$totaltemp0, na.rm = TRUE)-10),(max(combineddata$totaltemp10, na.rm = TRUE)+10)))
    ...
    rvalueDWvtemp02 <- cor(combineddata$DWperyear2, combineddata$totaltemp0, method ="pearson", use = "na.or.complete")
    DWvtemp52 <- lm(combineddata$totaltemp5~combineddata$DWperyear2)
    sumDWvtemp52 <- summary(DWvtemp52)
    rvalueDWvtemp52 <- cor(combineddata$DWperyear2, combineddata$totaltemp5, method ="pearson", use = "na.or.complete")
    DWvtemp102 <- lm(combineddata$totaltemp10~combineddata$DWperyear2)
    sumDWvtemp102 <- summary(DWvtemp102)
    rvalueDWvtemp102 <- cor(combineddata$DWperyear2, combineddata$totaltemp10, method ="pearson", use = "na.or.complete")
  }
  
  #compares Down-Valley Wind Days per year to air temp (60%)
  plot(combineddata$totaltempair~combineddata$DWperyear2, pch =20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Air Freezing Index (60%)"), xlab = "Down-Valley Wind Days", ylab = "Air Freezing Index (Summed FDD)")
  ...
  rvalueDWvairtemp2 <- cor(combineddata$DWperyear2, combineddata$totaltempair, method = "pearson", use = "na.or.complete")
  
  if(soiltempcheck){
    #compares Down-Valley Wind Days per year to soil temperature 0,5,10 cm (70%)
    plot(combineddata$totaltemp0~combineddata$DWperyear3, pch = 20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Soil Freezing Index (70%)"), xlab = "Down-Valley Wind Days", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(combineddata$totaltemp0, na.rm = TRUE)-10),(max(combineddata$totaltemp10, na.rm = TRUE)+10)))
    ...
    rvalueDWvtemp03 <- cor(combineddata$DWperyear3, combineddata$totaltemp0, method ="pearson", use = "na.or.complete")
    DWvtemp53 <- lm(combineddata$totaltemp5~combineddata$DWperyear3)
    sumDWvtemp53 <- summary(DWvtemp53)
    rvalueDWvtemp53 <- cor(combineddata$DWperyear3, combineddata$totaltemp5, method ="pearson", use = "na.or.complete")
    DWvtemp103 <- lm(combineddata$totaltemp10~combineddata$DWperyear3)
    sumDWvtemp103 <- summary(DWvtemp103)
    rvalueDWvtemp103 <- cor(combineddata$DWperyear3, combineddata$totaltemp10, method ="pearson", use = "na.or.complete")
  }
  
  #compares Down-Valley Wind Days per year to air temp (70%)
  plot(combineddata$totaltempair~combineddata$DWperyear3, pch =20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Air Freezing Index (70%)"), xlab = "Down-Valley Wind Days", ylab = "Air Freezing Index (Summed FDD)")
  ...
  rvalueDWvairtemp3 <- cor(combineddata$DWperyear3, combineddata$totaltempair, method = "pearson", use = "na.or.complete")
  
  if(soiltempcheck){
    #compares Down-Valley Wind Days per year to soil temperature 0,5,10 cm (80%)
    plot(combineddata$totaltemp0~combineddata$DWperyear4, pch = 20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Soil Freezing Index (80%)"), xlab = "Down-Valley Wind Days", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(combineddata$totaltemp0, na.rm = TRUE)-10),(max(combineddata$totaltemp10, na.rm = TRUE)+10)))
    ...
    rvalueDWvtemp04 <- cor(combineddata$DWperyear4, combineddata$totaltemp0, method ="pearson", use = "na.or.complete")
    DWvtemp54 <- lm(combineddata$totaltemp5~combineddata$DWperyear4)
    sumDWvtemp54 <- summary(DWvtemp54)
    rvalueDWvtemp54 <- cor(combineddata$DWperyear4, combineddata$totaltemp5, method ="pearson", use = "na.or.complete")
    DWvtemp104 <- lm(combineddata$totaltemp10~combineddata$DWperyear4)
    sumDWvtemp104 <- summary(DWvtemp104)
    rvalueDWvtemp104 <- cor(combineddata$DWperyear4, combineddata$totaltemp10, method ="pearson", use = "na.or.complete")
  }
  
  #compares Down-Valley Wind Days per year (80%) to air temp 
  plot(combineddata$totaltempair~combineddata$DWperyear4, pch =20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Air Freezing Index (80%)"), xlab = "Down-Valley Wind Days", ylab = "Air Freezing Index (Summed FDD)")
  ...
  rvalueDWvairtemp4 <- cor(combineddata$DWperyear4, combineddata$totaltempair, method = "pearson", use = "na.or.complete")
  
  #compares Down-Valley Wind Days per year to soil temperature 0,5,10 cm (25%)
  if(soiltempcheck){
    plot(combineddata$totaltemp0~combineddata$DWperyear25, pch = 20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Soil Freezing Index (25%)"), xlab = "Down-Valley Wind Days", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(combineddata$totaltemp0, na.rm = TRUE)-10),(max(combineddata$totaltemp10, na.rm = TRUE)+10)))
    abline(lm(combineddata$totaltemp0~combineddata$DWperyear25), col = "black")
    points(combineddata$totaltemp5~combineddata$DWperyear25, pch =20, col = "green")
    abline(lm(combineddata$totaltemp5~combineddata$DWperyear25), col = "green")
    points(combineddata$totaltemp10~combineddata$DWperyear25, pch =20, col = "red")
    abline(lm(combineddata$totaltemp10~combineddata$DWperyear25), col = "red")
    legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)
    DWvtemp025 <- lm(combineddata$totaltemp0~combineddata$DWperyear25)
    sumDWvtemp025 <- summary(DWvtemp025)
    rvalueDWvtemp025 <- cor(combineddata$DWperyear25, combineddata$totaltemp0, method ="pearson", use = "na.or.complete")
    DWvtemp525 <- lm(combineddata$totaltemp5~combineddata$DWperyear25)
    sumDWvtemp525 <- summary(DWvtemp525)
    rvalueDWvtemp525 <- cor(combineddata$DWperyear25, combineddata$totaltemp5, method ="pearson", use = "na.or.complete")
    DWvtemp1025 <- lm(combineddata$totaltemp10~combineddata$DWperyear25)
    sumDWvtemp1025 <- summary(DWvtemp1025)
    rvalueDWvtemp1025 <- cor(combineddata$DWperyear25, combineddata$totaltemp10, method ="pearson", use = "na.or.complete")
  }
  
  #compares Down-Valley Wind Days per year to air temp (25%)
  plot(combineddata$totaltempair~combineddata$DWperyear25, pch =20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Air Freezing Index (25%)"), xlab = "Down-Valley Wind Days", ylab = "Air Freezing Index (Summed FDD)")
  abline(lm(combineddata$totaltempair~combineddata$DWperyear25), col = "black")
  DWvairtemp25 <- lm(combineddata$totaltempair~combineddata$DWperyear25)
  sumDWvairtemp25 <- summary(DWvairtemp25)
  rvalueDWvairtemp25 <- cor(combineddata$DWperyear25, combineddata$totaltempair, method = "pearson", use = "na.or.complete")
  
  if(soiltempcheck){
    #compares Down-Valley Wind Days per year (fraction) to soil temperature 0,5,10 cm 
    plot(combineddata$totaltemp0~combineddata$frac, pch = 20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Soil Freezing Index (fraction)"), xlab = "Down-Valley Wind Days", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(combineddata$totaltemp0, na.rm = TRUE)-10),(max(combineddata$totaltemp10, na.rm = TRUE)+10)))
    ...
    sumDWvtemp0frac <- summary(DWvtemp0frac)
    rvalueDWvtemp0frac <- cor(combineddata$frac, combineddata$totaltemp0, method ="pearson", use = "na.or.complete")
    DWvtemp5frac <- lm(combineddata$totaltemp5~combineddata$frac)
    sumDWvtemp5frac <- summary(DWvtemp5frac)
    rvalueDWvtemp5frac <- cor(combineddata$frac, combineddata$totaltemp5, method ="pearson", use = "na.or.complete")
    DWvtemp10frac <- lm(combineddata$totaltemp10~combineddata$frac)
    sumDWvtemp10frac <- summary(DWvtemp10frac)
    rvalueDWvtemp10frac <- cor(combineddata$frac, combineddata$totaltemp10, method ="pearson", use = "na.or.complete")
  }
  
  #compares Down-Valley Wind Days per year (fraction) to air temp 
  plot(combineddata$totaltempair~combineddata$frac, pch =20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Air Freezing Index (fraction)"), xlab = "Down-Valley Wind Days", ylab = "Air Freezing Index (Summed FDD)")
  ...
  sumDWvairtempfrac <- summary(DWvairtempfrac)
  rvalueDWvairtempfrac <- cor(combineddata$frac, combineddata$totaltempair, method = "pearson", use = "na.or.complete")
  

  ## Air temperature v Soil temperature
  #compares Air temperature to soil temperature 0,5,10 cm 
  if(soiltempcheck){
    plot(combineddata$totaltemp0~combineddata$totaltempair, pch = 20, col = "black", main = paste(location, "Air and Soil Freezing Index"), xlab = "Air Freezing Index (Summed FDD)", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(combineddata$totaltemp0, na.rm = TRUE)-10),(max(combineddata$totaltemp10, na.rm = TRUE)+10)))
    ...
    rvalueairvtemp0 <- cor(combineddata$totaltempair, combineddata$totaltemp0, method = "pearson", use = "na.or.complete")
    airvtemp5 <- lm(combineddata$totaltemp5~combineddata$totaltempair)
    sumairvtemp5 <- summary(airvtemp5)
    rvalueairvtemp5 <- cor(combineddata$totaltempair, combineddata$totaltemp5, method = "pearson", use = "na.or.complete")
    airvtemp10 <- lm(combineddata$totaltemp10~combineddata$totaltempair)
    sumairvtemp10 <- summary(airvtemp10)
    rvalueairvtemp10 <- cor(combineddata$totaltempair, combineddata$totaltemp10, method = "pearson", use = "na.or.complete")
  }
  
  ##Down-Valley Wind Days (25%) v Longwave Radiation
  #compares Down-Valley Wind Days (25%) to Longwave Radiation
  plot(combineddata$totalradiation~combineddata$DWperyear25, pch =20, col = "black", main = paste(location, "Wintertime Down-Valley Winds\n and Incoming Longwave Radiation"), xlab = "Down-Valley Wind Days", ylab = "Longwave Radiation Days")
  abline(lm(combineddata$totalradiation~combineddata$DWperyear25), col = "black")
  iswinterwarmingRDDWD25 <- lm(combineddata$totalradiation~combineddata$DWperyear25)
  sumiswinterwarmingRDDWD25 <- summary(iswinterwarmingRDDWD25)
  rvalueRDvDWD25 <- cor(combineddata$DWperyear25, combineddata$totalradiation, method = "pearson", use = "na.or.complete")
  ...
  if(soiltempcheck){
    Note <- c("","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","")
    if(CoGnote){
      Note <- c("","","","","","","","","","","","","CoG LW","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","CoG LW","CoG LW","CoG LW","CoG LW","","","","","","","","","CoG LW")
    }
    if(LBnote){
      Note <- c("","","","","","","","","","","","","LB LW","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","LB LW","LB LW","LB LW","LB LW","","","","","","","","", "LB LW")
    }
    Intercept <- c(iswinterwarmingFDD0cm$coefficients[1], iswinterwarmingFDD5cm$coefficients[1], iswinterwarmingFDD10cm$coefficients[1], iswinterwarmingFDDAir$coefficients[1], iswinterwarmingFDD0cmnhwe$coefficients[1], iswinterwarmingFDD5cmnhwe$coefficients[1], iswinterwarmingFDD10cmnhwe$coefficients[1], iswinterwarmingFDDAirnhwe$coefficients[1], iswinterwarmingFDD0cmnoDW$coefficients[1], iswinterwarmingFDD5cmnoDW$coefficients[1], iswinterwarmingFDD10cmnoDW$coefficients[1], iswinterwarmingFDDAirnoDW$coefficients[1], iswinterwarmingRD$coefficients[1], iswinterwarmingWD$coefficients[1], windvtemp0$coefficients[1], windvtemp5$coefficients[1], windvtemp10$coefficients[1], windvtempair$coefficients[1], windvtemp0_noDW$coefficients[1], windvtemp5_noDW$coefficients[1], windvtemp10_noDW$coefficients[1], windvtempair_noDW$coefficients[1], DWvtemp0$coefficients[1], DWvtemp5$coefficients[1], DWvtemp10$coefficients[1], DWvairtemp$coefficients[1], DWvtemp02$coefficients[1], DWvtemp52$coefficients[1], DWvtemp102$coefficients[1], DWvairtemp2$coefficients[1], DWvtemp03$coefficients[1], DWvtemp53$coefficients[1], DWvtemp103$coefficients[1], DWvairtemp3$coefficients[1], DWvtemp04$coefficients[1], DWvtemp54$coefficients[1], DWvtemp104$coefficients[1], DWvairtemp4$coefficients[1], DWvtemp025$coefficients[1], DWvtemp525$coefficients[1], DWvtemp1025$coefficients[1], DWvairtemp25$coefficients[1], DWvtemp0frac$coefficients[1], DWvtemp5frac$coefficients[1], DWvtemp10frac$coefficients[1], DWvairtempfrac$coefficients[1], radvtemp0$coefficients[1], radvtemp5$coefficients[1], radvtemp10$coefficients[1], radiationvtempair$coefficients[1], airvtemp0$coefficients[1], airvtemp5$coefficients[1], airvtemp10$coefficients[1], dwby50$coefficients[1],dwby60$coefficients[1], dwby70$coefficients[1], dwby80$coefficients[1], dwby25$coefficients[1], iswinterwarmingRDDWD25$coefficients[1])
    slope <- c(iswinterwarmingFDD0cm$coefficients[2], iswinterwarmingFDD5cm$coefficients[2], iswinterwarmingFDD10cm$coefficients[2], iswinterwarmingFDDAir$coefficients[2], iswinterwarmingFDD0cmnhwe$coefficients[2], iswinterwarmingFDD5cmnhwe$coefficients[2], iswinterwarmingFDD10cmnhwe$coefficients[2], iswinterwarmingFDDAirnhwe$coefficients[2], iswinterwarmingFDD0cmnoDW$coefficients[1], iswinterwarmingFDD5cmnoDW$coefficients[1], iswinterwarmingFDD10cmnoDW$coefficients[1], iswinterwarmingFDDAirnoDW$coefficients[1], iswinterwarmingRD$coefficients[2], iswinterwarmingWD$coefficients[2], windvtemp0$coefficients[2], windvtemp5$coefficients[2], windvtemp10$coefficients[2], windvtempair$coefficients[2], windvtemp0_noDW$coefficients[2], windvtemp5_noDW$coefficients[2], windvtemp10_noDW$coefficients[2], windvtempair_noDW$coefficients[2], DWvtemp0$coefficients[2], DWvtemp5$coefficients[2], DWvtemp10$coefficients[2], DWvairtemp$coefficients[2], DWvtemp02$coefficients[2], DWvtemp52$coefficients[2], DWvtemp102$coefficients[2], DWvairtemp2$coefficients[2], DWvtemp03$coefficients[2], DWvtemp53$coefficients[2], DWvtemp103$coefficients[2], DWvairtemp3$coefficients[2], DWvtemp04$coefficients[2], DWvtemp54$coefficients[2], DWvtemp104$coefficients[2], DWvairtemp4$coefficients[2], DWvtemp025$coefficients[2], DWvtemp525$coefficients[2], DWvtemp1025$coefficients[2], DWvairtemp25$coefficients[2], DWvtemp0frac$coefficients[2], DWvtemp5frac$coefficients[2], DWvtemp10frac$coefficients[2], DWvairtempfrac$coefficients[2], radvtemp0$coefficients[2], radvtemp5$coefficients[2], radvtemp10$coefficients[2], radiationvtempair$coefficients[2], airvtemp0$coefficients[2], airvtemp5$coefficients[2], airvtemp10$coefficients[2], dwby50$coefficients[2],dwby60$coefficients[2], dwby70$coefficients[2], dwby80$coefficients[2], dwby25$coefficients[2], iswinterwarmingRDDWD25$coefficients[2])
    p_value <- c(sumiswinterwarmingFDD0cm$coefficients[8], sumiswinterwarmingFDD5cm$coefficients[8], sumiswinterwarmingFDD10cm$coefficients[8], sumiswinterwarmingFDDAir$coefficients[8], sumiswinterwarmingFDD0cmnhwe$coefficients[8], sumiswinterwarmingFDD5cmnhwe$coefficients[8], sumiswinterwarmingFDD10cmnhwe$coefficients[8], sumiswinterwarmingFDDAirnhwe$coefficients[8], sumiswinterwarmingFDD0cmnoDW$coefficients[8], sumiswinterwarmingFDD5cmnoDW$coefficients[8], sumiswinterwarmingFDD10cmnoDW$coefficients[8], sumiswinterwarmingFDDAirnoDW$coefficients[8], sumiswinterwarmingRD$coefficients[8], sumiswinterwarmingWD$coefficients[8], sumwindvtemp0$coefficients[8], sumwindvtemp5$coefficients[8], sumwindvtemp10$coefficients[8], sumwindvtempair$coefficients[8], sumwindvtemp0_noDW$coefficients[8], sumwindvtemp5_noDW$coefficients[8], sumwindvtemp10_noDW$coefficients[8], sumwindvtempair_noDW$coefficients[8], sumDWvtemp0$coefficients[8], sumDWvtemp5$coefficients[8], sumDWvtemp10$coefficients[8], sumDWvairtemp$coefficients[8], sumDWvtemp02$coefficients[8], sumDWvtemp52$coefficients[8], sumDWvtemp102$coefficients[8], sumDWvairtemp2$coefficients[8], sumDWvtemp03$coefficients[8], sumDWvtemp53$coefficients[8], sumDWvtemp103$coefficients[8], sumDWvairtemp3$coefficients[8], sumDWvtemp04$coefficients[8], sumDWvtemp54$coefficients[8], sumDWvtemp104$coefficients[8], sumDWvairtemp4$coefficients[8], sumDWvtemp025$coefficients[8], sumDWvtemp525$coefficients[8], sumDWvtemp1025$coefficients[8], sumDWvairtemp25$coefficients[8], sumDWvtemp0frac$coefficients[8], sumDWvtemp5frac$coefficients[8], sumDWvtemp10frac$coefficients[8], sumDWvairtempfrac$coefficients[8], sumradvtemp0$coefficients[8], sumradvtemp5$coefficients[8], sumradvtemp10$coefficients[8], sumradiationvtempair$coefficients[8], sumairvtemp0$coefficients[8], sumairvtemp5$coefficients[8], sumairvtemp10$coefficients[8], sumdwby50$coefficients[8], sumdwby60$coefficients[8], sumdwby70$coefficients[8], sumdwby80$coefficients[8], sumdwby25$coefficients[8], sumiswinterwarmingRDDWD25$coefficients[8])
    R_squared <- c(sumiswinterwarmingFDD0cm$r.squared, sumiswinterwarmingFDD5cm$r.squared, sumiswinterwarmingFDD10cm$r.squared, sumiswinterwarmingFDDAir$r.squared, sumiswinterwarmingFDD0cmnhwe$r.squared, sumiswinterwarmingFDD5cmnhwe$r.squared, sumiswinterwarmingFDD10cmnhwe$r.squared, sumiswinterwarmingFDDAirnhwe$r.squared, sumiswinterwarmingFDD0cmnoDW$r.squared, sumiswinterwarmingFDD5cmnoDW$r.squared, sumiswinterwarmingFDD10cmnoDW$r.squared, sumiswinterwarmingFDDAirnoDW$r.squared, sumiswinterwarmingRD$r.squared, sumiswinterwarmingWD$r.squared, sumwindvtemp0$r.squared, sumwindvtemp5$r.squared, sumwindvtemp10$r.squared, sumwindvtempair$r.squared, sumwindvtemp0_noDW$r.squared, sumwindvtemp5_noDW$r.squared, sumwindvtemp10_noDW$r.squared, sumwindvtempair_noDW$r.squared, sumDWvtemp0$r.squared, sumDWvtemp5$r.squared, sumDWvtemp10$r.squared, sumDWvairtemp$r.squared, sumDWvtemp02$r.squared, sumDWvtemp52$r.squared, sumDWvtemp102$r.squared, sumDWvairtemp2$r.squared, sumDWvtemp03$r.squared, sumDWvtemp53$r.squared, sumDWvtemp103$r.squared, sumDWvairtemp3$r.squared, sumDWvtemp04$r.squared, sumDWvtemp54$r.squared, sumDWvtemp104$r.squared, sumDWvairtemp4$r.squared, sumDWvtemp025$r.squared, sumDWvtemp525$r.squared, sumDWvtemp1025$r.squared, sumDWvairtemp25$r.squared, sumDWvtemp0frac$r.squared, sumDWvtemp5frac$r.squared, sumDWvtemp10frac$r.squared, sumDWvairtempfrac$r.squared,sumradvtemp0$r.squared, sumradvtemp5$r.squared, sumradvtemp10$r.squared, sumradiationvtempair$r.squared, sumairvtemp0$r.squared, sumairvtemp5$r.squared, sumairvtemp10$r.squared, sumdwby50$r.squared,sumdwby60$r.squared, sumdwby70$r.squared, sumdwby80$r.squared, sumdwby25$r.squared, sumiswinterwarmingRDDWD25$r.squared)
    R_value <- sqrt(R_squared)
    rvalue<- c(rvalueFDD0cm, rvalueFDD5cm, rvalueFDD10cm, rvalueFDDAir, rvalueFDD0cmnhwe, rvalueFDD5cmnhwe, rvalueFDD10cmnhwe, rvalueFDDAirnhwe, rvalueFDD0cmnoDW, rvalueFDD5cmnoDW, rvalueFDD10cmnoDW, rvalueFDDAirnoDW, rvalueRD, rvalueWD, rvaluewindvtemp0, rvaluewindvtemp5, rvaluewindvtemp10, rvaluewindvtempair, rvaluewindvtemp0_noDW, rvaluewindvtemp5_noDW, rvaluewindvtemp10_noDW, rvaluewindvtempair_noDW, rvalueDWvtemp0, rvalueDWvtemp5, rvalueDWvtemp10, rvalueDWvairtemp, rvalueDWvtemp02, rvalueDWvtemp52, rvalueDWvtemp102, rvalueDWvairtemp2, rvalueDWvtemp03, rvalueDWvtemp53, rvalueDWvtemp103, rvalueDWvairtemp3, rvalueDWvtemp04, rvalueDWvtemp54, rvalueDWvtemp104, rvalueDWvairtemp4, rvalueDWvtemp025, rvalueDWvtemp525, rvalueDWvtemp1025, rvalueDWvairtemp25, rvalueDWvtemp0frac, rvalueDWvtemp5frac, rvalueDWvtemp10frac, rvalueDWvairtempfrac, rvalueradvtemp0, rvalueradvtemp5, rvalueradvtemp10, rvalueradvtempair, rvalueairvtemp0, rvalueairvtemp5, rvalueairvtemp10, rvaluedwby50, rvaluedwby60, rvaluedwby70, rvaluedwby80, rvaluedwby25, rvalueRDvDWD25)
    sum_list <- data.frame(Intercept, slope, p_value, R_squared, R_value, rvalue, Note, row.names = c("Freezing Degree Days Overtime (0cm)", "Freezing Degree Days Overtime (5cm)", "Freezing Degree Days Overtime (10cm)", "Freezing Degree Days Overtime (Airtemp)", "Freezing Degree Days Overtime NHWE (0cm)", "Freezing Degree Days Overtime NHWE (5cm)", "Freezing Degree Days Overtime NHWE (10cm)", "Freezing Degree Days Overtime NHWE (Airtemp)", "Freezing Degree Days Overtime DWDR (0cm)", "Freezing Degree Days Overtime DWDR (5cm)", "Freezing Degree Days Overtime DWDR (10cm)", "Freezing Degree Days Overtime DWDR (Airtemp)", "Radiation Days Overtime", "Wind Days Overtime", "Wind Days v Soil FDD (0cm)", "Wind Days v Soil FDD (5cm)", "Wind Days v Soil FDD (10cm)", "Wind Days v Air FDD", "Wind Days (DWDR) v Soil FDD (0cm)", "Wind Days (DWDR) v Soil FDD (5cm)", "Wind Days (DWDR) v Soil FDD (10cm)", "Wind Days (DWDR) v Air FDD", "Down-Valley Wind Day (50%) v Soil FDD (0cm)", "Down-Valley Wind Day (50%) v Soil FDD (5cm)", "Down-Valley Wind Day (50%) v Soil FDD (10cm)", "Down-Valley Wind Day (50%) v Air FDD", "Down-Valley Wind Day (60%) v Soil FDD (0cm)", "Down-Valley Wind Day (60%) v Soil FDD (5cm)", "Down-Valley Wind Day (60%) v Soil FDD (10cm)", "Down-Valley Wind Day (60%) v Air FDD", "Down-Valley Wind Day (70%) v Soil FDD (0cm)", "Down-Valley Wind Day (70%) v Soil FDD (5cm)", "Down-Valley Wind Day (70%) v Soil FDD (10cm)", "Down-Valley Wind Day (70%) v Air FDD", "Down-Valley Wind Day (80%) v Soil FDD (0cm)", "Down-Valley Wind Day (80%) v Soil FDD (5cm)", "Down-Valley Wind Day (80%) v Soil FDD (10cm)", "Down-Valley Wind Day (80%) v Air FDD", "Down-Valley Wind Day (25%) v Soil FDD (0cm)", "Down-Valley Wind Day (25%) v Soil FDD (5cm)","Down-Valley Wind Day (25%) v Soil FDD (10cm)", "Down-Valley Wind Day (25%) v Air FDD", "Down-Valley Wind Day (frac) v Soil FDD (0cm)", "Down-Valley Wind Day (frac) v Soil FDD (5cm)", "Down-Valley Wind Day (frac) v Soil FDD (10cm)", "Down-Valley Wind Day (frac) v Air FDD", "LW Radiation v Soil FDD (0cm)", "LW Radiation v Soil FDD (5cm)", "LW Radiation v Soil FDD (10cm)", "LW Radiation v Air FDD", "Soil FDD v Air FDD (0cm)", "Soil FDD v Air FDD (5cm)", "Soil FDD v Air FDD (10cm)", "Number of Down-Valley Wind Days (50%)", "Number of Down-Valley Wind Days (60%)", "Number of Down-Valley Wind Days (70%)", "Number of Down-Valley Wind Days (80%)", "Number of Down-Valley Wind Days (25%)", "Radiation v DWD25"))
    write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/Summary.csv", row.names=TRUE)
    
    if(location == "Lake Bonney"){
      write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/LakeBonneySummary.csv", row.names=TRUE)
      LBsum_list <- sum_list
      LBcombineddata <- combineddata
    }
    if(location == "Explorers Cove"){
      write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/ExplorersCoveSummary.csv", row.names=TRUE)
      ECsum_list <- sum_list
      ECcombineddata <- combineddata
    }
    if(location == "Lake Brownworth"){
      write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/LakeBrownworthSummary.csv", row.names=TRUE)
      LBrsum_list <- sum_list
      LBrcombineddata <- combineddata
    }
    if(location == "Lake Fryxell"){
      write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/LakeFryxellSummary.csv", row.names=TRUE)
      LFsum_list <- sum_list
      LFcombineddata <- combineddata
    }
    if(location == "Lake Hoare"){
      write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/LakeHoareSummary.csv", row.names=TRUE)
      LHsum_list <- sum_list
      LHcombineddata <- combineddata
    }
    if(location == "Lake Vanda"){
      write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/LakeVandaSummary.csv", row.names=TRUE)
      LVasum_list <- sum_list
      LVacombineddata <- combineddata
    }
    if(location == "Lake Vida"){
      write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/LakeVidaSummary.csv", row.names=TRUE)
      LVisum_list <- sum_list
      LVicombineddata <- combineddata
    }
    if(location == "Miers Valley"){
      write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/MiersValleySummary.csv", row.names=TRUE)
      MVsum_list <- sum_list
      MVcombineddata <- combineddata
    }
    if(location == "Mount Fleming"){
      write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/MountFlemingSummary.csv", row.names=TRUE)
      MFsum_list <- sum_list
      MFcombineddata <- combineddata
    }
    if(location == "Taylor Glacier"){
      write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/TaylorGlacierSummary.csv", row.names=TRUE)
      TGsum_list <- sum_list
      TGcombineddata <- combineddata
    }
    if(location == "Canada Glacier"){
      write.csv(sum_list, "~/Dropbox/R_projects/mdv_winter_warming/CanadaGlacierSummary.csv", row.names=TRUE)
      CaGsum_list <- sum_list
      CaGcombineddata <- combineddata
    }
    if(location == "Commonwealth Glacier"){
  ...
  if(!soiltempcheck){
    ...
    if(CoGnote){
      Note <- c("","","","CoG LW","","","","","","","","","","CoG LW","","","","","","CoG LW")
    }
    if(LBnote){
      Note <- c("","","","LB LW","","","","","","","","","","LB LW","","","","","","LB LW")
    }
    Intercept <- c(iswinterwarmingFDDAir$coefficients[1], iswinterwarmingFDDAirnhwe$coefficients[1], iswinterwarmingFDDAirnoDW$coefficients[1], iswinterwarmingRD$coefficients[1], iswinterwarmingWD$coefficients[1], windvtempair$coefficients[1], windvtempair_noDW$coefficients[1], DWvairtemp$coefficients[1], DWvairtemp2$coefficients[1], DWvairtemp3$coefficients[1], DWvairtemp4$coefficients[1], DWvairtemp25$coefficients[1], DWvairtempfrac$coefficients[1], radiationvtempair$coefficients[1], dwby50$coefficients[1],dwby60$coefficients[1], dwby70$coefficients[1], dwby80$coefficients[1], dwby25$coefficients[1], iswinterwarmingRDDWD25$coefficients[1])
    slope <- c(iswinterwarmingFDDAir$coefficients[2], iswinterwarmingFDDAirnhwe$coefficients[2], iswinterwarmingFDDAirnoDW$coefficients[2], iswinterwarmingRD$coefficients[2], iswinterwarmingWD$coefficients[2], windvtempair$coefficients[2], windvtempair_noDW$coefficients[2], DWvairtemp$coefficients[2], DWvairtemp2$coefficients[2], DWvairtemp3$coefficients[2], DWvairtemp4$coefficients[2], DWvairtemp25$coefficients[2], DWvairtempfrac$coefficients[2], radiationvtempair$coefficients[2], dwby50$coefficients[2],dwby60$coefficients[2], dwby70$coefficients[2], dwby80$coefficients[2], dwby25$coefficients[2], iswinterwarmingRDDWD25$coefficients[2])
    p_value <- c(sumiswinterwarmingFDDAir$coefficients[8], sumiswinterwarmingFDDAirnhwe$coefficients[8], sumiswinterwarmingFDDAirnoDW$coefficients[8], sumiswinterwarmingRD$coefficients[8], sumiswinterwarmingWD$coefficients[8], sumwindvtempair$coefficients[8], sumwindvtempair_noDW$coefficients[8], sumDWvairtemp$coefficients[8], sumDWvairtemp2$coefficients[8], sumDWvairtemp3$coefficients[8], sumDWvairtemp4$coefficients[8], sumDWvairtemp25$coefficients[8], sumDWvairtempfrac$coefficients[8], sumradiationvtempair$coefficients[8], sumdwby50$coefficients[8], sumdwby60$coefficients[8], sumdwby70$coefficients[8], sumdwby80$coefficients[8], sumdwby25$coefficients[8], sumiswinterwarmingRDDWD25$coefficients[8])
    R_squared <- c(sumiswinterwarmingFDDAir$r.squared, sumiswinterwarmingFDDAirnhwe$r.squared, sumiswinterwarmingFDDAirnoDW$r.squared, sumiswinterwarmingRD$r.squared, sumiswinterwarmingWD$r.squared, sumwindvtempair$r.squared, sumwindvtempair_noDW$r.squared, sumDWvairtemp$r.squared, sumDWvairtemp2$r.squared, sumDWvairtemp3$r.squared, sumDWvairtemp4$r.squared, sumDWvairtemp25$r.squared, sumDWvairtempfrac$r.squared, sumradiationvtempair$r.squared, sumdwby50$r.squared, sumdwby60$r.squared, sumdwby70$r.squared, sumdwby80$r.squared, sumdwby25$r.squared, sumiswinterwarmingRDDWD25$r.squared)
    R_value <- sqrt(R_squared)
    rvalue <- c(rvalueFDDAir, rvalueFDDAirnhwe, rvalueFDDAirnoDW, rvalueRD, rvalueWD, rvaluewindvtempair, rvaluewindvtempair_noDW, rvalueDWvairtemp, rvalueDWvairtemp2, rvalueDWvairtemp3, rvalueDWvairtemp4, rvalueDWvairtemp25, rvalueDWvairtempfrac, rvalueradvtempair, rvaluedwby50, rvaluedwby60, rvaluedwby70, rvaluedwby80, rvaluedwby25, rvalueRDvDWD25)
    sum_list <- data.frame(Intercept, slope, p_value, R_squared, R_value, rvalue, Note, row.names = c("Freezing Degree Days Overtime (Airtemp)", "Freezing Degree Days Overtime NHWE (Airtemp)", "Freezing Degree Days Overtime DWDR (Airtemp)", "Radiation Days Overtime", "Wind Days Overtime", "Wind Days v Air FDD", "Wind Days (DWDR) v Air FDD", "Down-Valley Wind Day (50%) v Air FDD", "Down-Valley Wind Day (60%) v Air FDD", "Down-Valley Wind Day (70%) v Air FDD", "Down-Valley Wind Day (80%) v Air FDD", "Down-Valley Wind Day (25%) v Air FDD", "Down-Valley Wind Day (frac) v Air FDD", "LW Radiation v Air FDD", "Number of Down-Valley Wind Days (50%)", "Number of Down-Valley Wind Days (60%)", "Number of Down-Valley Wind Days (70%)", "Number of Down-Valley Wind Days (80%)", "Number of Down-Valley Wind Days (25%)", "Radiation v DWD25"))
...
#graphs used in paper

pdf('Graphsusedinpaper.pdf', width = 14, height = 7)

#GRAPH 1: Lake Hoare and Explorer's Cove winter Soil Freezing Index v year
par(mfrow=c(1,2))
par(mar= c(4,4,4,0))
plot(LHcombineddata$totaltemp0~LHcombineddata$year, pch = 20, col = "black", main = paste("Lake Hoare Winter Soil Freezing Index"), xlab = "Year", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(LHcombineddata$totaltemp0, na.rm = TRUE)-10),(max(LHcombineddata$totaltemp10, na.rm = TRUE)+10)), xlim = c(1994, max(LHcombineddata$year, na.rm = TRUE)))
abline(lm(LHcombineddata$totaltemp0~LHcombineddata$year), col = "black")
points(LHcombineddata$totaltemp5~LHcombineddata$year, pch =20, col = "green")
abline(lm(LHcombineddata$totaltemp5~LHcombineddata$year), col = "green")
points(LHcombineddata$totaltemp10~LHcombineddata$year, pch =20, col = "red")
abline(lm(LHcombineddata$totaltemp10~LHcombineddata$year), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

plot(ECcombineddata$totaltemp0~ECcombineddata$year, pch = 20, col = "black", main = paste("Explorer's Cove Winter Soil Freezing Index"), xlab = "Year", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(ECcombineddata$totaltemp0, na.rm = TRUE)-10),(max(ECcombineddata$totaltemp10, na.rm = TRUE)+10)), xlim = c(2003, max(ECcombineddata$year, na.rm = TRUE)))
abline(lm(ECcombineddata$totaltemp0~ECcombineddata$year), col = "black")
points(ECcombineddata$totaltemp5~ECcombineddata$year, pch =20, col = "green")
abline(lm(ECcombineddata$totaltemp5~ECcombineddata$year), col = "green")
points(ECcombineddata$totaltemp10~ECcombineddata$year, pch =20, col = "red")
abline(lm(ECcombineddata$totaltemp10~ECcombineddata$year), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

#GRAPH 2: Lake Fryxell and Explorer's Cove winter Air Freezing Index v year
par(mfrow=c(1,2))
plot(LFcombineddata$totaltempair~LFcombineddata$year, pch = 20, col = "black", main = paste("Lake Fryxell Winter Air Freezing Index"), xlab = "Year", ylab = "Air Freezing Index (Summed FDD)", xlim=c(1994, max(LFcombineddata$year, na.rm = TRUE)))
abline(lm(LFcombineddata$totaltempair~LFcombineddata$year), col = "black")

plot(ECcombineddata$totaltempair~ECcombineddata$year, pch = 20, col = "black", main = paste("Explorer's Cove Winter Air Freezing Index"), xlab = "Year", ylab = "Air Freezing Index (Summed FDD)", xlim=c(1998, max(ECcombineddata$year, na.rm = TRUE)))
abline(lm(ECcombineddata$totaltempair~ECcombineddata$year), col = "black")

#GRAPH 3: Thawing Degree Days (see other code)

#GRAPH 4: Lake Fryxell and Lake Hoare Winter Wind Total v year
par(mfrow=c(1,2))
plot(LFcombineddata$totalwind~LFcombineddata$year, pch = 20, col = "black", main = paste("Lake Fryxell Winter Wind Total"), xlab = "Year", ylab = "Wind Run (km)", xlim=c(1994, max(LFcombineddata$year, na.rm = TRUE)))
abline(lm(LFcombineddata$totalwind~LFcombineddata$year), col = "black")

plot(LHcombineddata$totalwind~LHcombineddata$year, pch = 20, col = "black", main = paste("Lake Hoare Winter Winter Wind Total"), xlab = "Year", ylab = "Wind Run (km)", xlim=c(1989, max(LHcombineddata$year, na.rm = TRUE)))
abline(lm(LHcombineddata$totalwind~LHcombineddata$year), col = "black")

#GRAPH 6: Lake Brownworth and Lake Vida Air freezing Index v Soil freezing index
par(mfrow=c(1,2))
plot(LBrcombineddata$totaltemp0~LBrcombineddata$totaltempair, pch = 20, col = "black", main = paste("Lake Brownworth Air and Soil Freezing Index"), xlab = "Air Freezing Index (Summed FDD)", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(LBrcombineddata$totaltemp0, na.rm = TRUE)-10),(max(LBrcombineddata$totaltemp10, na.rm = TRUE)+10)))
abline(lm(LBrcombineddata$totaltemp0~LBrcombineddata$totaltempair), col = "black")
points(LBrcombineddata$totaltemp5~LBrcombineddata$totaltempair, pch =20, col = "green")
abline(lm(LBrcombineddata$totaltemp5~LBrcombineddata$totaltempair), col = "green")
points(LBrcombineddata$totaltemp10~LBrcombineddata$totaltempair, pch =20, col = "red")
abline(lm(LBrcombineddata$totaltemp10~LBrcombineddata$totaltempair), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

plot(LVicombineddata$totaltemp0~LVicombineddata$totaltempair, pch = 20, col = "black", main = paste("Lake Vida Air and Soil Freezing Index"), xlab = "Air Freezing Index (Summed FDD)", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(LVicombineddata$totaltemp0, na.rm = TRUE)-10),(max(LVicombineddata$totaltemp10, na.rm = TRUE)+10)))
abline(lm(LVicombineddata$totaltemp0~LVicombineddata$totaltempair), col = "black")
points(LVicombineddata$totaltemp5~LVicombineddata$totaltempair, pch =20, col = "green")
abline(lm(LVicombineddata$totaltemp5~LVicombineddata$totaltempair), col = "green")
points(LVicombineddata$totaltemp10~LVicombineddata$totaltempair, pch =20, col = "red")
abline(lm(LVicombineddata$totaltemp10~LVicombineddata$totaltempair), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

#GRAPH 7: Lake Hoare and Lake Vanda Winter Wind total v Soil Freezing Index
par(mfrow=c(1,2))
plot(LHcombineddata$totaltemp0~LHcombineddata$totalwind, pch = 20, col = "black", main = paste("Lake Hoare Winter Wind Total and\n Soil Freezing Index"), xlab = "Wind Run (km)", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(LHcombineddata$totaltemp0, na.rm = TRUE)-10),(max(LHcombineddata$totaltemp10, na.rm = TRUE)+10)))
abline(lm(LHcombineddata$totaltemp0~LHcombineddata$totalwind), col = "black")
points(LHcombineddata$totaltemp5~LHcombineddata$totalwind, pch =20, col = "green")
abline(lm(LHcombineddata$totaltemp5~LHcombineddata$totalwind), col = "green")
points(LHcombineddata$totaltemp10~LHcombineddata$totalwind, pch =20, col = "red")
abline(lm(LHcombineddata$totaltemp10~LHcombineddata$totalwind), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

plot(LVacombineddata$totaltemp0~LVacombineddata$totalwind, pch = 20, col = "black", main = paste("Lake Vanda Winter Wind Total and\n Soil Freezing Index"), xlab = "Wind Run (km)", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(LVacombineddata$totaltemp0, na.rm = TRUE)-10),(max(LVacombineddata$totaltemp10, na.rm = TRUE)+10)))
abline(lm(LVacombineddata$totaltemp0~LVacombineddata$totalwind), col = "black")
points(LVacombineddata$totaltemp5~LVacombineddata$totalwind, pch =20, col = "green")
abline(lm(LVacombineddata$totaltemp5~LVacombineddata$totalwind), col = "green")
points(LVacombineddata$totaltemp10~LVacombineddata$totalwind, pch =20, col = "red")
abline(lm(LVacombineddata$totaltemp10~LVacombineddata$totalwind), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

#GRAPH 8: Miers Valley and Explorer's Cove Winter Wind total v Air freezing Index
par(mfrow=c(1,2))
plot(MVcombineddata$totaltempair~MVcombineddata$totalwind, pch = 20, col = "black", main = paste("Miers Valley Winter Wind Total and\n Air Freezing Index"), xlab = "Wind Run (km)", ylab = "Air Freezing Index (Summed FDD)")
abline(lm(MVcombineddata$totaltempair~MVcombineddata$totalwind), col = "black")

plot(ECcombineddata$totaltempair~ECcombineddata$totalwind, pch = 20, col = "black", main = paste("Explorer's Cove Winter Wind Total and\n Air Freezing Index"), xlab = "Wind Run (km)", ylab = "Air Freezing Index (Summed FDD)")
abline(lm(ECcombineddata$totaltempair~ECcombineddata$totalwind), col = "black")

#GRAPH 9: Lake Hoare and Lake Brownworth Winter Down-Valley Wind Day v Soil Freezing Index
par(mfrow=c(1,2))
plot(LHcombineddata$totaltemp0~LHcombineddata$DWperyear, pch = 20, col = "black", main = paste("Lake Hoare Winter Down-Valley Wind\n and Soil Freezing Index"), xlab = "Down-Valley Wind Days", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(LHcombineddata$totaltemp0, na.rm = TRUE)-10),(max(LHcombineddata$totaltemp10, na.rm = TRUE)+10)))
abline(lm(LHcombineddata$totaltemp0~LHcombineddata$DWperyear), col = "black")
points(LHcombineddata$totaltemp5~LHcombineddata$DWperyear, pch =20, col = "green")
abline(lm(LHcombineddata$totaltemp5~LHcombineddata$DWperyear), col = "green")
points(LHcombineddata$totaltemp10~LHcombineddata$DWperyear, pch =20, col = "red")
abline(lm(LHcombineddata$totaltemp10~LHcombineddata$DWperyear), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

plot(LBrcombineddata$totaltemp0~LBrcombineddata$DWperyear, pch = 20, col = "black", main = paste("Lake Brownworth Winter Down-Valley Wind\n and Soil Freezing Index"), xlab = "Down-Valley Wind Days", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(LVacombineddata$totaltemp0, na.rm = TRUE)-10),(max(LVacombineddata$totaltemp10, na.rm = TRUE)+10)))
abline(lm(LBrcombineddata$totaltemp0~LBrcombineddata$DWperyear), col = "black")
points(LBrcombineddata$totaltemp5~LBrcombineddata$DWperyear, pch =20, col = "green")
abline(lm(LBrcombineddata$totaltemp5~LBrcombineddata$DWperyear), col = "green")
points(LBrcombineddata$totaltemp10~LBrcombineddata$DWperyear, pch =20, col = "red")
abline(lm(LBrcombineddata$totaltemp10~LBrcombineddata$DWperyear), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

#GRAPH 10: Lake Hoare and Explorer's Cove Winter Down-Valley Wind Day v Air freezing Index
par(mfrow=c(1,2))
plot(LHcombineddata$totaltempair~LHcombineddata$DWperyear, pch = 20, col = "black", main = paste("Lake Hoare Winter Down-Valley Wind and\n Air Freezing Index"), xlab = "Down-Valley Wind Days", ylab = "Air Freezing Index (Summed FDD)")
abline(lm(LHcombineddata$totaltempair~LHcombineddata$DWperyear), col = "black")

plot(ECcombineddata$totaltempair~ECcombineddata$DWperyear, pch = 20, col = "black", main = paste("Explorer's Cove Winter Down-Valley Wind and\n Air Freezing Index"), xlab = "Down-Valley Wind Days", ylab = "Air Freezing Index (Summed FDD)")
abline(lm(ECcombineddata$totaltempair~ECcombineddata$DWperyear), col = "black")

#GRAPH 11: Lake Hoare and Explorer's Cove Longwave Radiation v Soil freezing Index
par(mfrow=c(1,2))
plot(LHcombineddata$totaltemp0~LHcombineddata$totalradiation, pch = 20, col = "black", main = paste("Lake Hoare Winter Longwave Radiation\n and Soil Freezing Index"), xlab = "Longwave Radiation", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(LHcombineddata$totaltemp0, na.rm = TRUE)-10),(max(LHcombineddata$totaltemp10, na.rm = TRUE)+10)))
abline(lm(LHcombineddata$totaltemp0~LHcombineddata$totalradiation), col = "black")
points(LHcombineddata$totaltemp5~LHcombineddata$totalradiation, pch =20, col = "green")
abline(lm(LHcombineddata$totaltemp5~LHcombineddata$totalradiation), col = "green")
points(LHcombineddata$totaltemp10~LHcombineddata$totalradiation, pch =20, col = "red")
abline(lm(LHcombineddata$totaltemp10~LHcombineddata$totalradiation), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

plot(ECcombineddata$totaltemp0~ECcombineddata$totalradiation, pch = 20, col = "black", main = paste("Explorer's Cove Winter Longwave Radiation\n and Soil Freezing Index"), xlab = "Longwave Radiation", ylab = "Soil Freezing Index (Summed FDD)", ylim = c((min(ECcombineddata$totaltemp0, na.rm = TRUE)-10),(max(ECcombineddata$totaltemp10, na.rm = TRUE)+10)))
abline(lm(ECcombineddata$totaltemp0~ECcombineddata$totalradiation), col = "black")
points(ECcombineddata$totaltemp5~ECcombineddata$totalradiation, pch =20, col = "green")
abline(lm(ECcombineddata$totaltemp5~ECcombineddata$totalradiation), col = "green")
points(ECcombineddata$totaltemp10~ECcombineddata$totalradiation, pch =20, col = "red")
abline(lm(ECcombineddata$totaltemp10~ECcombineddata$totalradiation), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

#GRAPH 12: Lake Fryxell and Lake Brownworth Longwave Radiation v Air Freezing Index
par(mfrow=c(1,2))
plot(LFcombineddata$totaltempair~LFcombineddata$totalradiation, pch = 20, col = "black", main = paste("Lake Fryxell Winter Longwave Radiation and\n Air Freezing Index"), xlab = "Longwave Radiation", ylab = "Air Freezing Index (Summed FDD)")
abline(lm(LFcombineddata$totaltempair~LFcombineddata$totalradiation), col = "black")

plot(LBrcombineddata$totaltempair~LBrcombineddata$totalradiation, pch = 20, col = "black", main = paste("Lake Brownworth Winter Longwave Radiation and\n Air Freezing Index"), xlab = "Longwave Radiation", ylab = "Air Freezing Index (Summed FDD)")
abline(lm(LBrcombineddata$totaltempair~LBrcombineddata$totalradiation), col = "black")

#GRAPH 13: Lake Fryxell and Lake Hoare Down-Valley Winds v Longwave Radiation
par(mfrow=c(1,2))
plot(LFcombineddata$totalradiation~LFcombineddata$DWperyear, pch = 20, col = "black", main = paste("Lake Fryxell Winter Down-Valley Wind and\n Longwave Radiation"), xlab = "Down-Valley Wind Days", ylab = "Longwave Radiation")
abline(lm(LFcombineddata$totalradiation~LFcombineddata$DWperyear), col = "black")

plot(LHcombineddata$totalradiation~LHcombineddata$DWperyear, pch = 20, col = "black", main = paste("Lake Hoare Winter Down-Valley Wind and\n Longwave Radiation"), xlab = "Down-Valley Wind Days", ylab = "Longwave Radiation")
abline(lm(LHcombineddata$totalradiation~LHcombineddata$DWperyear), col = "black")

#GRAPH 14: Lake Fryxell and Lake Bonney Air Freezing Index Down-Valley Wind Days removed v year
par(mfrow=c(1,2))
plot(LFcombineddata$meantempairnoDW~LFcombineddata$year, pch = 20, col = "black", main = paste("Lake Fryxell Winter Air Freezing Index\n (Down-Valley Wind Days Removed)"), xlab = "Year", ylab = "Average Temperature (\u00B0C)", xlim=c(1994, max(LFcombineddata$year, na.rm = TRUE)))
abline(lm(LFcombineddata$meantempairnoDW~LFcombineddata$year), col = "black")

plot(LBcombineddata$meantempairnoDW~LBcombineddata$year, pch = 20, col = "black", main = paste("Lake Bonney Winter Air Freezing Index\n (Down-Valley Wind Days Removed)"), xlab = "Year", ylab = "Average Temperature (\u00B0C)", xlim=c(1994, max(LBcombineddata$year, na.rm = TRUE)))
abline(lm(LBcombineddata$meantempairnoDW~LBcombineddata$year), col = "black")

#GRAPH 15: Lake Hoare and Lake Brownworth Soil Freezing Index Down-Valley Wind Days removed v year
par(mfrow=c(1,2))
plot(LHcombineddata$meantemp0noDW~LHcombineddata$year, pch = 20, col = "black", main = paste("Lake Hoare Winter Soil Freezing Index\n (Down-Valley Wind Days Removed)"), xlab = "Year", ylab = "Average Temperature (\u00B0C)", ylim = c((min(LHcombineddata$meantemp0noDW, na.rm = TRUE)-10),(max(LHcombineddata$meantemp10noDW, na.rm = TRUE)+10)), xlim=c(1994, max(LHcombineddata$year, na.rm = TRUE)))
abline(lm(LHcombineddata$meantemp0noDW~LHcombineddata$year), col = "black")
points(LHcombineddata$meantemp5noDW~LHcombineddata$year, pch =20, col = "green")
abline(lm(LHcombineddata$meantemp5noDW~LHcombineddata$year), col = "green")
points(LHcombineddata$meantemp10noDW~LHcombineddata$year, pch =20, col = "red")
abline(lm(LHcombineddata$meantemp10noDW~LHcombineddata$year), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

plot(LBrcombineddata$meantemp0noDW~LBrcombineddata$year, pch = 20, col = "black", main = paste("Lake Brownworth Winter Soil Freezing Index\n (Down-Valley Wind Days Removed)"), xlab = "Year", ylab = "Average Temperature (\u00B0C)", ylim = c((min(LBrcombineddata$meantemp0noDW, na.rm = TRUE)-10),(max(LBrcombineddata$meantemp10noDW, na.rm = TRUE)+10)), xlim=c(1997, max(LBrcombineddata$year, na.rm = TRUE)))
abline(lm(LBrcombineddata$meantemp0noDW~LBrcombineddata$year), col = "black")
points(LBrcombineddata$meantemp5noDW~LBrcombineddata$year, pch =20, col = "green")
abline(lm(LBrcombineddata$meantemp5noDW~LBrcombineddata$year), col = "green")
points(LBrcombineddata$meantemp10noDW~LBrcombineddata$year, pch =20, col = "red")
abline(lm(LBrcombineddata$meantemp10noDW~LBrcombineddata$year), col = "red")
legend("bottomright", legend = c("0cm","5cm", "10cm"), col = c("black","green", "red"), pch = 20)

dev.off()


pdf('Graphsusedinpaperthresholdplot.pdf', width = 14, height = 14)
#GRAPH 5: Lake Fryxell Wintertime Down-Vallry Wind Days different threshold
par(mfrow=c(2,2))
plot(LFcombineddata$DWperyear~LFcombineddata$year, pch = 20, col = "black", main = paste("Lake Fryxell Winter Down-Valley Wind Days\n (50% Fractional Day Threshold)"), xlab = "Year", ylab = "Number of Down-Valley Wind Days", ylim = c(0,(max(LFcombineddata$DWperyear, na.rm = TRUE)+1)))
abline(lm(LFcombineddata$DWperyear~LFcombineddata$year), col = "black")
plot(LFcombineddata$DWperyear2~LFcombineddata$year, pch = 20, col = "black", main = paste("Lake Fryxell Winter Down-Valley Wind Days\n (60% Fractional Day Threshold)"), xlab = "Year", ylab = "Number of Down-Valley Wind Days", ylim = c(0,(max(LFcombineddata$DWperyear, na.rm = TRUE)+1)))
abline(lm(LFcombineddata$DWperyear2~LFcombineddata$year), col = "black")
plot(LFcombineddata$DWperyear3~LFcombineddata$year, pch = 20, col = "black", main = paste("Lake Fryxell Winter Down-Valley Wind Days\n (70% Fractional Day Threshold)"), xlab = "Year", ylab = "Number of Down-Valley Wind Days", ylim = c(0,(max(LFcombineddata$DWperyear, na.rm = TRUE)+1)))
abline(lm(LFcombineddata$DWperyear3~LFcombineddata$year), col = "black")
plot(LFcombineddata$DWperyear4~LFcombineddata$year, pch = 20, col = "black", main = paste("Lake Fryxell Winter Down-Valley Wind Days\n (80% Fractional Day Threshold)"), xlab = "Year", ylab = "Number of Down-Valley Wind Days", ylim = c(0,(max(LFcombineddata$DWperyear, na.rm = TRUE)+1)))
abline(lm(LFcombineddata$DWperyear4~LFcombineddata$year), col = "black")
dev.off()